...
public class Fragment1 extends Fragment {
    ...
    public void setButtonBack(String path) {
        ...
        Button button = (Button) getView().findViewById(R.id.button6);
    ...
    public void setBLines(String path) {
        ...
        list.add(getView().findViewById(R.id.bline_monday_1));
    ...
    public void setSLines(String path) {
        ArrayList<View> list = new ArrayList<>();
        list.add(getView().findViewById(R.id.sline_monday_1));
